    ...
    <Box bg="black" w="100%" p={2}>
      <Container as={Flex} color="white" justifyContent={"space-between"} fontSize="xs" size={{
        ...
        <Flex gap="1.5rem">
          ...
          <Flex as={Link} display={{base: 'none', sm: 'flex'}} href="#" alignItems="center" gap="0.5rem"><Image src="/ico-small-location.svg"
              width={24} height="24" alt=""/> Ukraine, Kyiv,Khreshchatyk 1</Flex>

          <Flex as={Link} display={{base: 'none', sm: 'flex'}} href="#" alignItems="center" gap="0.5rem">
            <Image src="/ico-small-clock.svg" width={24} height="24" alt="" /> All week 24/7</Flex>
        </Flex>
